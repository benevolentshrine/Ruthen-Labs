...
func configPath() (string, error) {
	...
	return filepath.Join(home, ".config", "unit01", "config.toml"), nil
}

// LoadConfig reads ~/.config/unit01/config.toml.
...
// SaveConfig writes cfg to ~/.config/unit01/config.toml, creating intermediate
